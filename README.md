...
You can see my code here:
 - [Java](https://github.com/Bohdankm22/intrv)
...
- ### Arrays
    ...
    - [x] Implement an ArrayList (mutable array with automatic resizing):
        - [x] Practice coding using arrays
        ...
        - [x] add(item)
        - [x] add(index, item) - inserts item at index, shifts that index's value and trailing elements to the right
        - [x] addFirst(item) - can use insert above at index 0
        - [x] pop() - remove from end, return value
        - [x] remove(index) - delete item at index, shifting all trailing elements left
...
- ### Linked Lists
    ...
    - [ ] implement (I did with tail pointer & without):
        ...
        - [x] add(index, value) - insert value at index, so current item at that index is pointed to by new item at index
...
- ### Stack
    ...
    - [x] Will not implement. Implementing with array is trivial. Also implemented as part of LinkedList.
...
- ### Binary search trees: BSTs
    ...
    - [ ] Implement (for Set and Map):
        - [x] put    // insert value into tree
        - [x] getSize // get count of values stored
        - [x] getKeyList // getList of keys from min to max
        - [x] removeAll
        - [x] contains // returns true if given value exists in the tree
